...
if __name__ == "__main__":
    ...
    parser.add_argument('--suffix', type=str, default='231125')
    parser.add_argument('--load_cached_graphs',  type=str2bool, default=False)
    parser.add_argument('--load_cached_pairs', type=str2bool, default=False)
